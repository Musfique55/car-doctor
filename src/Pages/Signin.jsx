        ...
        <div className='mx-5 md:mx-12 lg:mx-14'>
            <div className=" min-h-screen">
                <div className="hero-content flex-col lg:flex-row">
                    ...
                    <h2 className='text-center text-[#444444] font-semibold text-4xl'>Sign In</h2>
                    <form className="card-body" onSubmit={handleSubmit}>
                        ...
                        <p className='mt-7 font-medium text-lg text-center'>Or Sign In with</p>
                    </form>
                    <div className=''>
                        ...
                        <button onClick={handleGoogle} className='bg-[#F5F5F8] p-4 rounded-full'><img src={google} alt="" /></button>
                        </div>
                        <p className='text-[#737373] font-normal font-lg text-center mt-12'>Do not have an account? <Link to="/signup" className='text-[#FF3811] font-semibold text-lg'>Sign Up</Link></p>
                    </div>
                    </div>
                </div>
            </div>
